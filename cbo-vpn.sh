...
add_pptp_vpn_user()
{
  ...
  sudo editor ${config_path}ppp/chap-secrets
...
config_pptp_vpn()
{
  ...
  sudo editor ${config_path}pptpd.conf
  # Add user
  backup_file ${config_path}ppp/chap-secrets
  sudo editor ${config_path}ppp/chap-secrets
  #echo "
  ...
  #  sudo editor ${config_path}ppp/peers/delhi-idc-01
  ...
  #sudo editor ${config_path}ppp/ip-up.d/route-traffic
  # sudo chmod +x ${config_path}ppp/ip-up.d/route-traffic
  sudo killall pptpd
  sudo pptpd
}
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
