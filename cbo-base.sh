...
translate_fr ()
{
  ...
  sudo __package_cp -y -u install sudo aptitude-doc-fr # Manuel français pour sudo aptitude, un gestionnaire de paquets en ligne de commande
...
mount_to_home ()
{
  ...
  UUID=... /home ...
  "
  sudo sudo editor ${config_path}fstab
