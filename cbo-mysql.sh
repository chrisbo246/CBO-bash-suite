...
__mysql_config()
{
  #mysql_config=$( find / -type f -name "my.cnf" -exec grep -l "bind-address" {} \;  2>/dev/null)
  #mysql_service=$( find / -type f -path "*/init.d/*" -name "mysql"  2>/dev/null)
  #running_test
}
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
uninstall_mysql ()
...
move_mysql_data_dir()
{
  ...
  #sudo editor ${config_path}mysql/conf.d/datadir.cnf
  ...
  case $choice in
    y,Y,yes,YES)
      # Copy the existing data directory (sudo which is located in /var/lib/mysql) using the command
...
install_phpmyadmin ()
{
  ...
  sudo sudo chmod 644 /usr/share/phpmyadmin/config.inc.php           # Modifier les modes d'accès du fichier
}
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
