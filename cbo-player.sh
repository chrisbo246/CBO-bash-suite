...
install_multimedia_codecs ()
{
  ...
  # Install the GStreamer back-end sudo which can play DVDs but does not yet support DVD menus.
  ...
  # Install the xine back-end sudo which can play DVDs with full DVD menu suport.
